            ...
            <form action="{{route('food.update',$food)}}" method="post">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="w-full">
                        ...
                        <x-text-input id="description" name="description" type="text" class="mt-1 block w-full" :value="$food->description"  required autofocus autocomplete="name" />
                        <x-input-error class="mt-2" :messages="$errors->get('description')" />
                    </div>
                    <div class="w-full">

                        <x-input-label for="price" :value="__('Price')" />
                        <x-text-input id="price" name="price" type="text" class="mt-1 block w-full" :value="$food->price" required autofocus autocomplete="name" />
